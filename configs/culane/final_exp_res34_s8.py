...
vaniehsd_radius = 8
joint_nums = 1                                   
joint_weights = [1, 0.4, 0.2]                    
joint_weights1 = [1, 0.4, 0.2]                    
joint_weights2 = [1, 0.4, 0.2]                    
joint_weights3 = [1, 0.4, 0.2]                    
joint_weights4 = [1, 0.4, 0.2]                    
sample_per_lane = [41, 21, 11]                   
dcn_point_num = [7, 5, 3]                        
sample_gt_points = [41, 21, 11]                 
...
train_pipeline = [
    ...
    dict(
        ...
        keys=['img', 'gt_cpts_hm', 'gt_kpts_hm', 'int_offset', 'pts_cfe',
...
log_level = 'INFO'
work_dir = './work_dirs/culane/resnet34'
load_from = None
resume_from = None
