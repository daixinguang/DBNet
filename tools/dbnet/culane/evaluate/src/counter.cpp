...
//                      cout << "curr_anno_lane = ";
//                      for (int i=0; i<4;i++) {
//                          cout <<  curr_detect_lane[i];
//                      }
//                      cout << endl;

                            

                        //cout << "curr_anno_lane = " << curr_anno_lane<< endl;
                        //cout << "curr_detect_lane = " << curr_detect_lane << endl;
                        similarity[i][j] = lane_compare->get_lane_similarity(curr_anno_lane, curr_detect_lane);
                        //cout << "anno=" <<i  <<" detect=" << j  <<" similarity[" <<i<< "][" << j << "] = "<<similarity[i][j] <<endl;
		}
	}
